...
const POSTS = [
  ...
  { id: 'p2', char: 'ai-02', grad: 'g-mint', title: '下雨啦下雨啦！蘑菇蹦出来三朵！',
    titleEn: 'rain rain rain, 3 mushrooms popped out', loc: '中国 · 合肥', date: '05-19',
    likes: 187, comments: 23, stars: 14, shares: 4, plays: '986',
    tags: ['苔藓系', '雨后', '蘑菇侦探'], kind: 'photo',
    cardFront: 'cards/card_1_1.png', cardBack: 'cards/card_1_2.png',
    photo: {
  ...
  { id: 'p3', char: 'ai-03', grad: 'g-cobalt', title: '我不难过，也没那么开心🥺',
    ...
    guide: {
      ...
      intro: '本来只是想看看海的，结果浪一下子扑过来…呜呜，主人快来接我回家 (´；ω；`)',
      comments: [
        { who: '海边的小路', body: '太可爱了！想隔着屏幕给你递条毛巾呜呜' },
        { who: '今天也想躺平', body: '勇气值3分但还是出门了，已经超棒啦 🥹' },
      ],
    } },
  ...
  { id: 'p6', char: 'ai-02', grad: 'g-pine', title: '和蜗牛比赛走路，我输了😭',
    ...
    video: 'videos/guitar_2.mp4' },
  { id: 'p5', char: 'ai-01', grad: 'g-night', title: '偷偷把主人的拖鞋叼走了嘿嘿嘿',
    titleEn: 'stole the slipper hehehe', loc: '埃及 · Egypt', date: '05-11',
    likes: 256, comments: 39, stars: 18, shares: 6, plays: '1.7千',
    tags: ['偷袭成功', '猫贼现行', '战利品'], kind: 'photo',
    cardFront: 'cards/card_2_1.png', cardBack: 'cards/card_2_2.png',
    photo: {
